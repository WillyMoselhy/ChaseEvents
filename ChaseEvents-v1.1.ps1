        ...
        switch ($EventRecord.Id){
            "1069"{ # ----- Resource Failed - WS16
                ...
                if ($OutputLevel -eq "Standard"){
                    ...
                    $Result = $EventRecord.Properties[0].Value+'|'+$EventRecord.Properties[1].Value+'|'+$EventRecord.Properties[2].Value
                }
                break
            }
            ...
            "1564"{ # ----- Failed to arbitrate for the file share 
                    ...
                    if($OutputLevel -eq "Standard"){
                        ...
                        $Result = $EventRecord.Properties[0].Value + '|' + $EventRecord.Properties[1].Value
                    }
                    break
            }
            "5120"{ # ----- CSV entered a paused state - For WS16:
                ...
                if($OutputLevel -eq "Standard"){
                    ...
                    $Result = $EventRecord.Properties[1].Value + '|' + $EventRecord.Properties[2].Value
                }
                break
            }
            "5142"{ # ----- CSV No longer accessible
                ...
                if ($OutputLevel -eq "Standard"){
                    ...
                    $Result = $EventRecord.Properties[1].Value + '|' + $EventRecord.Properties[2].Value + '|' + $EventRecord.Properties[3].Value
                }
                break
            }
